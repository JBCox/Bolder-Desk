  ...
  template: `
    <div class="inline-block">
      @switch (name()) {
        ...
        @case ('merge') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 2.75a2.75 2.75 0 0 0-4.32 2.02l-1.48 2.22a2.75 2.75 0 1 0 0 5.02l1.48 2.22a2.75 2.75 0 1 0 4.32 2.02"/><path d="M8 18.25a2.75 2.75 0 1 0 0-5.5 2.75 2.75 0 0 0 0 5.5Z"/><path d="M16 8h-5.5"/></svg>
        }
        @case ('library') {
        ...
        @case ('split') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 3h5v5"/><path d="M8 3H3v5"/><path d="M12 22v-8.3a4 4 0 0 0-1.17-2.83L8 8"/><path d="m15 9-3-3"/><path d="M21 16v-5h-5"/><path d="M3 8v5h5"/></svg>
        }
        @case ('play-circle') {
        ...
        @case ('bug') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 8s-5-5-10-5-8 5-8 5v9c0 1.7 1.3 3 3 3h14c1.7 0 3-1.3 3-3V8Z"/><line x1="10" y1="18" x2="14" y2="18"/><path d="m16 12-4-4-4 4"/><path d="M12 2v4"/><path d="M20 8h-4"/><path d="M4 8h4"/></svg>
        }
        @case ('credit-card') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
        }
        @case ('sparkles') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 3-1.9 5.8-5.8 1.9 5.8 1.9L12 18l1.9-5.8 5.8-1.9-5.8-1.9Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>
        }
        @case ('bell') {
        ...
        @case ('slack') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12.83 12.83a2 2 0 0 0-2.83 0 2 2 0 0 0 0 2.83 2 2 0 0 0 2.83 0 2 2 0 0 0 0-2.83z"></path><path d="M11.17 5.17a2 2 0 0 0-2.83 0 2 2 0 0 0 0 2.83 2 2 0 0 0 2.83 0 2 2 0 0 0 0-2.83z"></path><path d="M5.17 11.17a2 2 0 0 0 0 2.83 2 2 0 0 0 2.83 0 2 2 0 0 0 0-2.83 2 2 0 0 0-2.83 0z"></path><path d="M12.83 5.17a2 2 0 0 0 0 2.83 2 2 0 0 0 2.83 0 2 2 0 0 0 0-2.83 2 2 0 0 0-2.83 0z"></path><path d="M18.83 11.17a2 2 0 0 0-2.83 0 2 2 0 0 0 0 2.83 2 2 0 0 0 2.83 0 2 2 0 0 0 0-2.83z"></path><path d="M18.83 12.83a2 2 0 0 0 0 2.83 2 2 0 0 0 2.83 0 2 2 0 0 0 0-2.83 2 2 0 0 0-2.83 0z"></path><path d="M8 12.83a2 2 0 0 0-2.83 0 2 2 0 0 0 0 2.83 2 2 0 0 0 2.83 0 2 2 0 0 0 0-2.83z"></path><path d="M11.17 18.83a2 2 0 0 0 2.83 0 2 2 0 0 0 0-2.83 2 2 0 0 0-2.83 0 2 2 0 0 0 0 2.83z"></path></svg>
        }
        @case ('clipboard') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>
        }
        @case ('rocket') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.12-.67-.82-2.32-1.01-3.15-.06zM13 3c-2.43 2.94-2.43 7.36 0 10.3C14.73 15.42 17.5 16 17.5 16s.58-2.77 2.5-4.2C22 10 22 6 22 6s-4.2 0-5.8 2.24C14.5 10.24 13 3 13 3z"/><path d="M9 13c-2.43-2.94-2.43-7.36 0-10.3C10.73.58 13.5 0 13.5 0s.58 2.77 2.5 4.2C18 6 18 10 18 10s-4.2 0-5.8-2.24C10.5 5.76 9 13 9 13z"/></svg>
        }
        @case ('target') {
        ...
        @case ('webhook') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 16.98h.01"/><path d="M17.6 11.33A6.002 6.002 0 0 1 12 6a6 6 0 0 1-5.6 5.33"/><path d="M12 12v3.34a6.002 6.002 0 0 1-5.6 5.33"/><path d="M12 12v3.34a6.002 6.002 0 0 0 5.6 5.33"/><path d="M12 6a6 6 0 0 0-5.6 5.33"/><circle cx="12" cy="12" r="2"/></svg>
        }
        @case ('brain-circuit') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4a2 2 0 0 1 2 2v2a2 2 0 0 0 2 2"/><path d="M12 2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-4a2 2 0 0 0-2 2v2a2 2 0 0 1-2 2"/><path d="M12 22a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-4a2 2 0 0 1-2-2v-2a2 2 0 0 0-2-2"/><path d="M12 22a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2h4a2 2 0 0 0 2-2v-2a2 2 0 0 1 2-2"/><path d="M15 12a3 3 0 1 0-6 0 3 3 0 1 0 6 0Z"/><path d="M4 8V6a2 2 0 0 1 2-2"/><path d="M4 16v2a2 2 0 0 0 2 2"/><path d="M20 8V6a2 2 0 0 0-2-2"/><path d="M20 16v2a2 2 0 0 1-2 2"/></svg>
        }
        ...
        @case ('layout-template') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="7" rx="2" ry="2"/><rect x="3" y="14" width="7" height="7" rx="2" ry="2"/><rect x="14" y="14" width="7" height="7" rx="2" ry="2"/></svg>
        }
        @case ('link') {
        ...
        @case ('heart-pulse') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-2.5l-2.5 5-5-10-2.5 5H2"/><path d="M15.5 8.5A5.5 5.5 0 0 0 10 14c2.5 4 6 5.5 6 5.5s3.5-1.5 6-5.5c-1-5-6-5.5-6-5.5Z"/></svg>
        }
        @case ('mic') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>
        }
        @case ('pin') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22V8M5 8h14M12 8l-4 4h8l-4-4Z"></path></svg>
        }
        @case ('pie-chart') {
        ...
        @case ('salesforce') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 5-5V9a5 5 0 0 0-5-5Z"/></svg>
        }
        @case ('jira') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m11.88 2.1-7.73 7.73a1 1 0 0 0 0 1.41l7.73 7.73a1 1 0 0 0 1.41 0l7.73-7.73a1 1 0 0 0 0-1.41L13.3 2.1a1 1 0 0 0-1.42 0z"/><path d="m12.59 5.41-3 3"/></svg>
        }
        @case ('glasses') {
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="15" r="4" /><circle cx="18" cy="15" r="4" /><path d="M14 15a4 4 0 0 0-8 0" /><path d="M2.5 13L5 7" /><path d="M21.5 13L19 7" /></svg>
        }
        @case ('refresh-cw') {
